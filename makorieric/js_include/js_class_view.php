<?php 
	...
	$catid = $results['class'];
	$js_db_query = "SELECT * FROM js_class WHERE catid = '$catid'";
		...
		<br>
          ...
          <br><hr><br>
			<div class="main_content">
				<form role="form" method="post" name="PostCategory" action="index.php?action=viewcat&&js_catid=<?php echo $catid ?>" encclass="multipart/form-data" >
