		...
		<br>
          ...
          <br><hr><br>
			<div class="main_content">
				<form role="form" method="post" name="SaveItem" action="index.php?action=edititem&&js_itemid=<?php echo $itemid ?>" encclass="multipart/form-data" >
			...
			<?php $js_db_query = "SELECT * FROM js_class ORDER BY cat_title ASC";
				$database = new Js_Dbconn();			
				...
				<tr>
					...
					<input type="hidden" name="itemimg" value="<?php echo $item_img ?>">	
						...
						<input name="filename" autocomplete="off" class="file" accept="image/*" >
						</td></tr></table>
					</td>
				</tr>
