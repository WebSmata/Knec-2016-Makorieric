		...
		<br>
          ...
          <br><hr><br>
			<div class="main_content">
				<form role="form" method="post" name="PostTopic" action="index.php?action=topic_new" encclass="multipart/form-data" >
				...
				<tr>
					...
					<td><input type="text" autocomplete="off" name="address"></td>
                        ...
                        <center><input type="submit" class="submit_this" name="AddSupp" value="Save and Add Another Topic">
