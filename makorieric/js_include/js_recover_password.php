		  ...
		  <h2>Reset Your Password</h2>
			...
			<table style="width:100%;font-size:20px;">
				<tr>
					...
					<td><input class="password" name="password" id="password" autocomplete="off" required autofocus  maxlength="20"/></td>
				</tr>
				<tr><td>Confirm Password (*required)</td>
			<td>
			<input class="password" name="passwordcon" id="passwordcon" autocomplete="off" required autofocus maxlength="20" />
			</td></tr>
			</table>
