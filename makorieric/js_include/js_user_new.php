<?php include JS_THEME."js_header.php"; ?>
	<div id="site_content">	
	  ...
	  <div id="content"> 
		...
		<br>
		  <h1>Add an Nafaka User</h1> 
          <br><hr><br>
			<div class="main_content">
				<form role="form" method="post" name="PostUser" action="index.php?action=newuser" encclass="multipart/form-data" >
				...
				<tr>
					...
					<td><input name="avatar" autocomplete="off" class="file" accept="image/*"></td>
				</tr>
				...
				<tr>
					...
					<td><input class="password" autocomplete="off" name="password"></td>
				</tr>
				
				<tr>
					<td>Confirm Password:</td>
					<td><input class="password" autocomplete="off" name="passwordcon"></td>
				</tr>
